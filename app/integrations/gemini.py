...
def categorize(
    ...
    def _write_log(*, success: bool, error_code: str | None) -> None:
        log_ai_call(
            user.jwt,
    ...
    try:
        ...
        _write_log(success=True, error_code=None)
        return suggestion

    except GeminiError as exc:
        _write_log(success=False, error_code=exc.error_code)
        raise
    except Exception:
        _write_log(success=False, error_code="unknown")
        raise
